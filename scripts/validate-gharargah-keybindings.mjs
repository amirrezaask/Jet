...
const DEFAULTS_FILE = join(ROOT, "packages/gharargah-workspace/src/default-keybindings.ts")
const MAP_FILE = join(ROOT, "packages/gharargah-workspace/data/jet-vscode-command-map.json")
