 ...
 * Output: src-tauri/target/release/bundle/macos/Gharargah-Tauri.app
 */
...
const productName = JSON.parse(fs.readFileSync(path.join(tauriDir, "tauri.conf.json"), "utf8")).productName ?? "Gharargah-Tauri"
