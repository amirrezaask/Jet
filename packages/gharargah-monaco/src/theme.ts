...
import { isDarkTheme, type GharargahTheme } from "@gharargah/shared"
...
/** Register (or re-register) a Gharargah theme with Monaco. Returns the Monaco theme name. */
export function registerGharargahMonacoTheme(theme: GharargahTheme): string {
  const name = `gharargah-${theme.id}`
...
/** Apply a Gharargah theme to Monaco editors. */
export function applyGharargahMonacoTheme(theme: GharargahTheme): string {
  const name = registerGharargahMonacoTheme(theme)
  monaco.editor.setTheme(name)
  return name
}

export function gharargahMonacoThemeName(theme: GharargahTheme): string {
  return `gharargah-${theme.id}`
}

export function isGharargahMonacoThemeRegistered(theme: GharargahTheme): boolean {
  return registeredThemes.has(gharargahMonacoThemeName(theme))
}
