import { YAADE_LAYOUT_EPSILON, YAADE_RATE_SCROLL, radStepToward } from "./rad-motion.js"
...
export class RadScrollController {
  ...
  private tick(time: number): void {
    ...
    const step = radStepToward(
      this.currentValue,
      this.targetValue,
      this.options.rate ?? YAADE_RATE_SCROLL,
      dt,
      this.epsilon(),
    )
  ...
  private epsilon(): number {
    return this.options.epsilon ?? YAADE_LAYOUT_EPSILON
  }
