...
export const YAADE_RATE_HOT = 60
export const YAADE_RATE_MENU = 70
export const YAADE_RATE_SLOW_MENU = 50
export const YAADE_RATE_SCROLL = 60
export const YAADE_RATE_ENTITY = 30
export const YAADE_RATE_THEME = 30

export const YAADE_ANIM_EPSILON = 0.005
