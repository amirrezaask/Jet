import { GHARARGAH_LAYOUT_EPSILON, GHARARGAH_RATE_SCROLL, radStepToward } from "./rad-motion.js"
...
export class RadScrollController {
  ...
  private tick(time: number): void {
    ...
    const step = radStepToward(
      this.currentValue,
      this.targetValue,
      this.options.rate ?? GHARARGAH_RATE_SCROLL,
      dt,
      this.epsilon(),
    )
  ...
  private epsilon(): number {
    return this.options.epsilon ?? GHARARGAH_LAYOUT_EPSILON
  }
