...
function TreeRowChrome<T>({
  ...
  return (
    <SidebarMenuSubButton
      ...
      className={cn(
        "group/tree-row h-[var(--gharargah-row-height)] w-full shrink-0 cursor-pointer gap-1 rounded-sm px-2",
    ...
    >
      ...
      >
        {ctx.isBranch ? (
          <ChevronRight
            className={cn(
              "size-3 shrink-0 transition-transform duration-[var(--gharargah-motion-fast)]",
...
export function Lister<T>({
  ...
  return (
    <div
      ...
      data-gharargah-lister
      data-gharargah-lister-mode={mode}
      onPointerDown={() => {
        scrollRef.current?.focus()
      }}
    >
