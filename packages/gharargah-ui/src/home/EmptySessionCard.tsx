    ...
    <NewSessionButton
      ...
      trigger={
        <button
          ...
          className="gharargah-home-empty-session flex w-full min-h-16 flex-col items-start justify-center gap-0.5 rounded-[var(--glass-radius-panel)] border border-dashed border-primary/30 bg-transparent px-3 py-2.5 text-left shadow-none"
        >
