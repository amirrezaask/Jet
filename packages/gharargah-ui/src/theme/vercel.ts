import type { JetHighlightColors, GharargahTheme } from "@gharargah/codemirror"
...
export const vercelDark: GharargahTheme = {
  id: "vercel-dark",
  name: "Vercel Dark",
  colors: {
    bg: "#000000",
...
export const vercelLight: GharargahTheme = {
  id: "vercel-light",
  name: "Vercel Light",
  colors: {
    bg: "#ffffff",
...
export const vercelBundledThemes: Record<string, GharargahTheme> = {
  dark: vercelDark,
  light: vercelLight,
}
