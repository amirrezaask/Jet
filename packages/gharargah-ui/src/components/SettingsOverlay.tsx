...
export function SettingsOverlay({
  ...
  const grouped = themes.reduce<Record<string, GharargahTheme[]>>((acc, theme) => {
    const key = theme.family ?? "Gharargah"
    ;(acc[key] ??= []).push(theme)
    return acc
  }, {})
              ...
              <section className="flex flex-col gap-3">
                ...
                <SettingsField label="Editor and terminal cursor shape">
                  <ToggleGroup
                    ...
                    className="w-full"
                  >
                    <ToggleGroupItem value="block" data-gharargah-setting="terminal-cursor-style-block" className="flex-1">Block</ToggleGroupItem>
                    <ToggleGroupItem value="bar" data-gharargah-setting="terminal-cursor-style-bar" className="flex-1">Bar</ToggleGroupItem>
                    <ToggleGroupItem value="underline" data-gharargah-setting="terminal-cursor-style-underline" className="flex-1">Line</ToggleGroupItem>
                  </ToggleGroup>
                </SettingsField>
                <SettingsField label="Editor and terminal cursor motion" detail="Trail uses a bounded five-frame ghost tail.">
                  <ToggleGroup
                    ...
                    className="w-full"
                  >
                    <ToggleGroupItem value="trail" data-gharargah-setting="terminal-cursor-motion-trail" className="flex-1">Trail</ToggleGroupItem>
                    <ToggleGroupItem value="smooth" data-gharargah-setting="terminal-cursor-motion-smooth" className="flex-1">Smooth</ToggleGroupItem>
                    <ToggleGroupItem value="off" data-gharargah-setting="terminal-cursor-motion-off" className="flex-1">Off</ToggleGroupItem>
                  </ToggleGroup>
                </SettingsField>
              </section>
