...
import { detectSessionProvider } from "@yaade/ui"
...
const OTHER_GROUP_ID = "yaade:terminal-explorer:other"
...
export function buildTerminalExplorerGroups(
  treeOrTrees: YaadePanelTree | YaadePanelTree[],
  workspace: WorkspaceService,
...
export function nextTerminalLabel(tree: YaadePanelTree): string {
