...
export function ModalEditorPane(props: ModalEditorPaneProps) {
  ...
  const activeTabDomId = activeTabId
    ? `yaade-editor-tab-${encodeURIComponent(activeTabId)}`
    : undefined
  ...
  return (
    ...
    >
      ...
      <ResizablePanelGroup
        ...
        data-yaade-modal-editor-content-group=""
        className="relative min-h-0 flex-1 overflow-hidden"
      >
        <ResizablePanel id="editor-content" minSize="240px">
          <div
            id="yaade-modal-editor-tabpanel"
            role="tabpanel"
            aria-labelledby={activeTabDomId}
            data-yaade-modal-editor-content=""
      ...
      >
        ...
        <span
          data-yaade-editor-language={activeFile?.languageId ?? "plaintext"}
        ...
        <span
          data-yaade-editor-lsp={lspStatus}
