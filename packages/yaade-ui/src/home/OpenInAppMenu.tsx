...
const LAST_APP_KEY = "yaade-open-in-app-last"
...
export function OpenInAppMenu(props: OpenInAppMenuProps) {
  const {
    ...
    align = "end",
    className,
    "data-yaade-open-in-app": dataAttr = "true",
  } = props
    ...
    <DropdownMenu open={open} onOpenChange={setOpen}>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          size="sm"
          variant="outline"
          data-yaade-open-in-app={dataAttr}
          className={cn(
      ...
      <DropdownMenuContent
        ...
        data-yaade-open-in-app-menu
      >
        <DropdownMenuGroup>
          {OPEN_IN_APP_TARGETS.map(target => (
            <DropdownMenuItem
              key={target.id}
              data-yaade-open-in-app-item={target.id}
