...
export function ProjectSidebarItem({
  ...
  const renderSessionList = (
    ...
    <SidebarMenu
      className="gap-0.5"
      data-yaade-sidebar-session-section={section}
    >
  ...
  return (
    <Collapsible
      ...
      data-yaade-sidebar-project={project.id}
    >
      <SidebarMenuItem>
        <ContextMenu>
          <ContextMenuTrigger asChild>
            <CollapsibleTrigger asChild>
              <SidebarMenuButton
                ...
                className="h-8"
                data-yaade-sidebar-project-row={project.id}
              ...
              >
                <ChevronRight
                  className={cn(
                    "size-3.5 shrink-0 transition-transform duration-[var(--yaade-motion-fast)]",
                    expanded && "rotate-90",
                  )}
                  aria-hidden
                />
          ...
          <ContextMenuContent data-yaade-project-context-menu="">
            {menuItems}
          </ContextMenuContent>
        </ContextMenu>
        ...
        <SidebarMenuAction
          ...
          data-yaade-sidebar-project-new={project.id}
        >
        ...
        <CollapsibleContent>
          <SidebarMenuSub data-yaade-sidebar-project-sessions={project.id}>
                ...
                {archivedSessions.length > 0 ? (
                  <div className="flex flex-col gap-0.5">
                    <Button
                      ...
                      variant="ghost"
                      size="xs"
                      className="h-auto w-full justify-start gap-1 px-2 py-1 text-3xs font-medium uppercase tracking-wide text-muted-foreground hover:bg-transparent hover:text-sidebar-foreground"
                      aria-expanded={archivedExpanded}
                      data-yaade-sidebar-section-label="archived"
                      data-yaade-sidebar-section-toggle="archived"
                      data-state={archivedExpanded ? "open" : "closed"}
