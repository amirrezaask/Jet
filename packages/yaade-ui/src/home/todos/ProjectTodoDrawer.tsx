...
export function ProjectTodoDrawer(props: ProjectTodoDrawerProps) {
  ...
  return (
    ...
    >
      <DrawerContent
        id={`yaade-todo-drawer-${projectId}`}
        data-yaade-todo-drawer
        ...
        <DrawerHeader className="gap-2 border-b border-border/50 text-left md:gap-2">
          ...
          >
            <TabsList variant="line" className="h-8 w-full justify-start gap-0 rounded-none bg-transparent p-0">
              <TabsTrigger value="all" className="h-8 flex-none px-3 text-3xs" data-yaade-todo-filter="all">
                All
              </TabsTrigger>
              <TabsTrigger value="open" className="h-8 flex-none px-3 text-3xs" data-yaade-todo-filter="open">
                Open
              </TabsTrigger>
              <TabsTrigger value="done" className="h-8 flex-none px-3 text-3xs" data-yaade-todo-filter="done">
                Done
              </TabsTrigger>
            </TabsList>
          </Tabs>
