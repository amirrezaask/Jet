...
export function SessionTerminalTabBar(props: SessionTerminalTabBarProps) {
  ...
  return (
    <div
      data-yaade-session-header-tabs="terminal"
      className={cn(
    ...
    >
      <div
        ...
        data-yaade-session-terminal-tabs=""
      ...
      >
        {items.map(item => {
          ...
          return (
            <div
              key={item.id}
              data-yaade-session-terminal-tab-shell={item.id}
            ...
            >
              <button
                ...
                data-yaade-session-terminal-tab={item.id}
                data-active={selected ? "" : undefined}
              ...
              <button
                ...
                data-yaade-session-terminal-tab-close={item.id}
                data-yaade-close-session-terminal={item.id}
                disabled={!closable}
                className={cn(
      ...
      <div className="flex shrink-0 items-center">
        <Button
          ...
          variant="ghost"
          size="icon-sm"
          data-yaade-new-session-terminal=""
...
export function SessionTerminalWorkspace(
  ...
  return (
    <section
      data-yaade-session-terminal-workspace=""
      className={cn(
      ...
      <div className="relative min-h-0 min-w-0 flex-1 overflow-hidden">
        {items.map(item => {
          ...
          return (
            <div
              key={item.id}
              data-yaade-session-terminal-pane={item.id}
              data-active={selected ? "" : undefined}
              hidden={!selected}
