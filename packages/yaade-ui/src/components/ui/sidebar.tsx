  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-(--sidebar-width) bg-transparent transition-[width] duration-[var(--yaade-motion-panel)] ease-[var(--yaade-ease-drawer)]",
          "group-data-[yaade-sidebar-resizing]/sidebar-wrapper:transition-none",
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[transform,width] duration-[var(--yaade-motion-panel)] ease-[var(--yaade-ease-drawer)] md:flex",
          "group-data-[yaade-sidebar-resizing]/sidebar-wrapper:transition-none",
          side === "left"
...
function SidebarRail({
  ...
  const setResizing = React.useCallback(
    (active: boolean) => {
      const el = wrapperEl()
      if (!el) return
      if (active) el.dataset.yaadeSidebarResizing = ""
      else delete el.dataset.yaadeSidebarResizing
    },
    [wrapperEl],
  )
    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <button
          ...
          className={cn(
            "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-[background-color,color] duration-[var(--yaade-motion-fast)] ease-out group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border sm:flex",
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-[var(--yaade-motion-panel)] ease-[var(--yaade-ease-drawer)] focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm ring-sidebar-ring outline-hidden transition-[width,height,padding] duration-[var(--yaade-motion-panel)] ease-[var(--yaade-ease-drawer)] group-data-[yaade-sidebar-resizing]/sidebar-wrapper:transition-none group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
