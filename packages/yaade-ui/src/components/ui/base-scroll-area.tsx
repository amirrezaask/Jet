...
function ScrollBar({
  ...
  return (
    <ScrollAreaPrimitive.Scrollbar
      className={cn(
        "m-1 flex opacity-0 transition-opacity delay-[var(--yaade-motion-slow-menu)] data-[orientation=horizontal]:h-1.5 data-[orientation=vertical]:w-1.5 data-[orientation=horizontal]:flex-col data-hovering:opacity-100 data-scrolling:opacity-100 data-hovering:delay-0 data-scrolling:delay-0 data-hovering:duration-[var(--yaade-motion-fast)] data-scrolling:duration-[var(--yaade-motion-fast)]",
        className,
      )}
