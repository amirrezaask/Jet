...
export const TERMINAL_EXPLORER_LIST_ID = "yaade:terminal-explorer"
          ...
          return (
            <>
              <span className="relative flex size-4 shrink-0 items-center justify-center" aria-hidden>
                ...
                <span
                  data-yaade-terminal-status={entry.status}
