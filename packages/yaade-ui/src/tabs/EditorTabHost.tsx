...
import { fileUriToPath, isUntitledUri } from "@yaade/shared"
import type { KeymapContext, JetKeyBinding, WorkspaceService } from "@yaade/workspace"
...
export function syncAllEditorThemes(_theme: YaadeTheme): void {
  // Theme applied via MonacoEditorHost prop / applyYaadeMonacoTheme
}
  ...
  return (
    ...
    >
      ...
      <EditorContextMenu
        ...
        lspAvailable={Boolean(typeof window !== "undefined" && window.yaade?.lsp)}
