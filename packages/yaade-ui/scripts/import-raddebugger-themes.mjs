#!/usr/bin/env node
/**
 * Parse RAD Debugger theme presets from raddbg.mdesk and emit YaadeTheme definitions.
 *
 * Usage:
 *   node packages/yaade-ui/scripts/import-raddebugger-themes.mjs [path-to-raddbg.mdesk]
 *
...
function emitFile(themes) {
  ...
  return `// Generated by packages/yaade-ui/scripts/import-raddebugger-themes.mjs — do not edit by hand.
import {
  makeTheme,
  paletteAnsi,
  paletteColors,
