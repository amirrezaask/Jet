...
export class WorkspaceService {
  ...
  focusTabInPanel(tree: GharargahPanelTree, panelId: PanelId, tabId: string): void {
  ...
  closeTabInPanel(tree: GharargahPanelTree, panelId: PanelId, tabId: string): void {
    const view = tree.getView(panelId)
    if (view?.kind !== "tabs") return
  ...
  popPanelBuffer(tree: GharargahPanelTree, panelId: PanelId, uri: string): void {
    const view = tree.getView(panelId)
    if (view?.kind !== "tabs") return
    const tabId =
  ...
  showPanelView(tree: GharargahPanelTree, panelId: PanelId, view: PanelView): void {
  ...
  panelHasExplorerTab(tree: GharargahPanelTree, panel: PanelId): boolean {
    return panelHasTab(tree.getView(panel), EXPLORER_TAB_ID)
  }

  mountExplorerTab(tree: GharargahPanelTree, panelId: PanelId): void {
