...
export function highlightRangeTemporarily(
  ...
  const id = `yaade-highlight-${++highlightDecorationCounter}`
    ...
    [
      {
        range,
        options: {
          inlineClassName: "yaade-monaco-range-highlight",
          className: "yaade-monaco-range-highlight",
          isWholeLine: false,
          overviewRuler: {
            color: "var(--yaade-accent, #3b82f6)",
            position: 4,
          },
        },
      },
