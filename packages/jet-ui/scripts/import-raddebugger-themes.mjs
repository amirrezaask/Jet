#!/usr/bin/env node
/**
 * Parse RAD Debugger theme presets from raddbg.mdesk and emit JetTheme definitions.
 *
 * Usage:
 *   node packages/jet-ui/scripts/import-raddebugger-themes.mjs [path-to-raddbg.mdesk]
 *
...
function emitFile(themes) {
  ...
  return `// Generated by packages/jet-ui/scripts/import-raddebugger-themes.mjs — do not edit by hand.
import {
  makeTheme,
  paletteAnsi,
  paletteColors,
