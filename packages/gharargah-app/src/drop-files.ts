import { basename, fileUriToPath, pathToFileUri } from "@gharargah/shared"
...
import { formatDroppedPaths } from "@gharargah/ui/terminal-file-drop"
...
export async function handleDroppedPaths(
  ...
  if (zone === "terminal") {
    ...
    if (ptyId && terminal) {
      ...
      targetEl
        ?.closest("[data-gharargah-terminal-panel]")
