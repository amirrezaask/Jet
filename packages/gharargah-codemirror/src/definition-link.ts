      ...
      return Decoration.set([
        Decoration.mark({
          ...
          attributes: {
            ...
            "data-gharargah-definition-link": "",
          },
  ...
  return [
    ...
    EditorView.theme({
      ".cm-definition-link": {
        ...
        background: "color-mix(in srgb, var(--gharargah-accent) 14%, transparent)",
        textDecoration: "underline",
        textDecorationColor: "color-mix(in srgb, var(--gharargah-accent) 78%, transparent)",
