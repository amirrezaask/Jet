...
/** Re-enable skipped flaky specs: `YAADE_E2E_RUN_FLAKY=1 pnpm test:e2e` */
export const skipFlaky = process.env.YAADE_E2E_RUN_FLAKY !== "1"

export function flakyReason(detail: string): string {
  return `flaky (disabled): ${detail} — see AGENTS.md § Disabled flaky E2E specs`
}

/** Whole describe block skipped when `skipFlaky` (unless `YAADE_E2E_RUN_FLAKY=1`). */
